...
\begin{document}
    ...
    \begin{longtable}{l p{450pt}}
        ...
        Responsibilities:
        \begin{itemize}
            \item application skeleton configuration (database schema migration, API code generation, unit testing);
        ...
        Responsibilities:
        \begin{itemize}
            \item application skeleton configuration (database schema migration, API code generation, unit \& integration testing);
            \item code style definition;
            \item estimation;
            \item code review;
